...
namespace TrProtocol
{
    ...
    /// 
    /// </summary>
    public class Msg27ProjectileUpdate : INetObject
    {
        public const int ID = 27;
        /// <summary>
        /// 
        /// </summary>
        public short projectileId = default(short);        /// <summary>
        /// 
        /// </summary>
        ...
        /// Player ID
        /// </summary>
        public byte owner = default(byte);        /// <summary>
        /// 
        /// </summary>
        public short type = default(short);        /// <summary>
        /// 
        /// </summary>
        public BitsByte projFlags = new BitsByte();        /// <summary>
        /// Only sent if AI[0] flag is true
        /// </summary>
        public float AI0 = default(float);        /// <summary>
        /// Only sent if AI[1] flag is true
        /// </summary>
        public float AI1 = default(float);        /// <summary>
        /// Only sent if Damage flag is true
        /// </summary>
        public short Damage = default(short);        /// <summary>
        /// Only sent if Knockback flag is true
        /// </summary>
        public float knockback = default(float);        /// <summary>
        /// Only sent if OriginalDamage flag is true
        /// </summary>
        public short originalDamage = default(short);        /// <summary>
